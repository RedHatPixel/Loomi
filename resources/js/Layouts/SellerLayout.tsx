...
const SIDEBAR_LINKS = [
    { label: 'Dashboard',    href: route('seller.dashboard'),        icon: ChartBarIcon,    routeName: 'seller.dashboard',      badgeKey: undefined },
    { label: 'Products',     href: route('seller.products.index'),   icon: CubeIcon,        routeName: 'seller.products.*',     badgeKey: undefined },
    { label: 'Orders',       href: route('seller.orders.index'),     icon: ShoppingBagIcon, routeName: 'seller.orders.*',       badgeKey: 'seller_pending_orders' },
    { label: 'Settings',     href: route('seller.settings'),         icon: Cog6ToothIcon,   routeName: 'seller.settings',       badgeKey: undefined },
] as const;
...
export default function SellerLayout({ header, children }: Props) {
    const { auth, seller_pending_orders } = usePage<PageProps>().props;
    ...
    return (
        <div className="min-h-screen bg-surface-page font-sans">
            ...
            {/* Sidebar — always fixed so it scrolls independently */}
            <aside
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    {/* Navigation — scrollable independent of main content */}
